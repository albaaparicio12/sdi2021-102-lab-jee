...
public class NotaneitorTests {
	...
	public void PR05() {
		...
		PO_RegisterView.fillForm(driver, "77777678A", "Josefo", "Perez", "77777",
		"77777");
	...
	public void PR06() {
		...
		PO_RegisterView.checkKey(driver, "Error.signup.lastName.length",
				PO_Properties.getSPANISH() );
		//Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990A", "Josefo", "Perez", "7","7");
		//Comprobamos el error de contraseña corta.
		PO_RegisterView.checkKey(driver, "Error.signup.password.length", PO_Properties.getSPANISH() );
		//Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "99999990A", "Josefo", "Perez", "788888","79999");
		//Comprobamos el error de contraseña corta.
	...
	//PRN. Loguearse con exito desde el  ROL profesor 99999993D, 123456
	@Test
	public void PR08() {
		//Vamos al formulario de logueo.
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
	...
	//PRN. Loguearse con exito desde el ROL Administrador (99999988F/123456).
	@Test
	public void PR09() {
		//Vamos al formulario de logueo.
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
	...
	//PRN. Loguearse sin exito desde el ROL alumno (1233488F/123456).
	@Test
	public void PR010() {
		//Vamos al formulario de logueo.
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
		//Rellenamos el formulario
		PO_LoginView.fillForm(driver, "1233488F" , "123456" );
		//COmprobamos que entramos en la pagina privada de Alumno
	...
	public void PR15() {
		...
		SeleniumUtils.EsperaCargaPaginaNoTexto(driver, "Nueva Nota 1",PO_View.getTimeout());
		//Ahora nos desconectamos
		PO_PrivateView.clickOption(driver, "logout", "text", "Identifícate");
	}
}
